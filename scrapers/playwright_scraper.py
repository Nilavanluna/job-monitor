...
Mastercard, Visa, CrowdStrike, Accenture, IrishJobs.ie (multi-keyword).
Location: all of Ireland.

JobsIE removed — confirmed broken (JS error on their search page means
results never render, not a selector issue on our end).
"""
from playwright.sync_api import sync_playwright, TimeoutError as PWTimeout
from scrapers._keywords import KEYWORDS, HARD_EXCLUDE, IRELAND_TERMS, EXCLUDE_NON_IRELAND_CITIES
from scrapers.irish_boards import scrape_irishjobs_multi
...
def scrape_all(companies: list[dict]) -> list[dict]:
    ...
    with sync_playwright() as p:
        ...
        # Standard single-page-per-company scrapers
        ...
        # IrishJobs.ie — multi-keyword search, runs separately
        irishjobs_jobs = scrape_irishjobs_multi(context)
